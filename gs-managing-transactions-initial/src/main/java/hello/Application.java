...
public class Application {
	...
	public static void main(String[] args) {
		...
		log.info("You shouldn't see Chris or Samuel. Samuel violated DB constraints, and Chris was in the same TX");
		...
		log.info("You shouldn't see Buddy or null. null violated DB constraints, and Buddy was roll back in the same TX");
